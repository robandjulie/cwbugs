...
<div class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <div class="content"<?php print $content_attributes; ?>>
  	...
  	<div class="location-date-tickets-url-wrapper">

	  	<div class="location-date-tickets-url-date">
	  		<div class="month"><?php print $month; ?></div>
	  		<div class="day"><?php print $day; ?></div>
	  	</div>

	  	<div class="location-date-tickets-url-location">
	  	...
	  	<?php if ($ticket_url): ?>
		<div class="location-date-tickets-url-tickets">
